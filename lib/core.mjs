...
function codeTaskOverallStatus({ worktreeExists, patchExists, patchVerifyOk, reviewExists, reviewJsonExists, closeoutExists, closeoutStatus, cleanupRecommendation }) {
...
function statusNextActions({ queue, summary, worktreeExists, patchExists, patchVerifyOk, reviewExists, reviewJsonExists, closeoutExists, closeoutStatus, cleanupRecommendation }) {
  ...
  if (!closeoutExists || closeoutStatus !== 'closed') {
